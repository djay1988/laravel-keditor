...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/dep/bootstrap-3.4.1/css/bootstrap.min.css') }}" data-type="keditor-style" />
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('assets/plugins/dep/bootstrap-3.4.1/js/bootstrap.min.js') }}"></script>
