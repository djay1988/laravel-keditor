        ...
        function (t, n, e) {
                ...
                d = function (t, n, e, o, a, i) {
                    var r = this.options,
                        ...
                        T = '\n        <section\n            class="'
                            .concat(c.UI, " ")
                            .concat(c.SNIPPET, " ")
                            .concat("container" === t ? c.SNIPPET_CONTAINER : c.SNIPPET_COMPONENT, '"\n            data-snippet="#')
                            .concat(l, '"\n            data-type="')
                            .concat(t, '"\n            data-keditor-title="')
                    ...
                    return (
                        (o = o.split(r.snippetsCategoriesSeparator)),
                            "container" === t ? (this.categoryContainer = this.categoryContainer.concat(o)) : -1 !== t.indexOf("component") && (this.categoryComponent = this.categoryComponent.concat(o)),
                            [T, E]
                    );
                },
                O = function () {
            ...
            var v = function () {
                    ...
                    a.html(
                        '\n        <span class="'
                            ...
                            .concat(n.locale.snippetCategoryLabel, ':</span>\n        <select class="')
                            .concat(c.UI, " ")
                    ...
                    var i,
                        ...
                        s = function () {
                            ...
                            a.filter(".".concat(c.STATE_SELECTED)).removeClass(c.STATE_SELECTED),
                                e || o
                                    ? a.each(function () {
                                        var t = $(this),
                ...
                m = function () {
                    ...
                    (this.modalTarget = null),
                        ...
                        t.find(".".concat(c.STATE_NOT_MATCHED)).removeClass(c.STATE_NOT_MATCHED),
                ...
                P = { CONTENT_AREA: 1e3, CONTAINER: 2e3, CONTAINER_CONTENT: 2100, CONTAINER_BOTTOM: 2200, SUB_CONTAINER: 3e3, SUB_CONTAINER_BOTTOM: 3100, SUB_CONTAINER_CONTENT: 3200, COMPONENT: 4e3, COMPONENT_BOTTOM: 4100 },
                D = {
                ...
                g = function (t, n) {
                    ...
                    switch (t) {
                        ...
                        case P.SUB_CONTAINER:
                            return (
                                n && (o = '<a href="javascript:void(0);" class="'.concat(c.UI, " ").concat(c.CONTAINER_SETTING, '" title="').concat(e.locale.setting, '">').concat(D.SETTING_CONTAINER, "</a>")),
                                    '\n                <div class="'
                                        .concat(c.UI, " ")
                                        .concat(c.TOOLBAR, " ")
                                        .concat(c.TOOLBAR_CONTAINER, " ")
                                        .concat(t === P.SUB_CONTAINER ? c.TOOLBAR_SUB_CONTAINER : "", '">\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                                        .concat(c.CONTAINER_MOVE, '" title="')
                                        .concat(e.locale.move, '">')
                                        .concat(D.MOVE_CONTAINER, '</a>\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                                        .concat(c.CONTAINER_MOVE_UP, '" title="')
                                        .concat(e.locale.moveUp, '">')
                                        .concat(D.MOVE_UP_CONTAINER, '</a>\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                                        ...
                                        .concat(e.locale.cut, '">')
                                        .concat(D.CUT_CONTAINER, '</a>\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                                        .concat(c.CONTAINER_COPY, '" title="')
                                        .concat(e.locale.copy, '">')
                                        .concat(D.COPY_CONTAINER, '</a>\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                                        .concat(c.CONTAINER_DELETE, '" title="')
                                        .concat(e.locale.delete, '">')
                                        .concat(D.DELETE_CONTAINER, "</a>\n                </div>\n            ")
                            );
                        case P.COMPONENT:
                            return (
                                n && (o = '<a href="javascript:void(0);" class="'.concat(c.UI, " ").concat(c.COMPONENT_SETTING, '" title="').concat(e.locale.setting, '">').concat(D.SETTING_COMPONENT, "</a>")),
                                    '\n                <div class="'
                                        .concat(c.UI, " ")
                                        .concat(c.TOOLBAR, " ")
                                        .concat(c.TOOLBAR_COMPONENT, '">\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                                        .concat(c.COMPONENT_MOVE, '" title="')
                                        .concat(e.locale.move, '">')
                                        .concat(D.MOVE_COMPONENT, '</a>\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                                        .concat(c.COMPONENT_MOVE_UP, '" title="')
                                        .concat(e.locale.moveUp, '">')
                                        .concat(D.MOVE_UP_COMPONENT, '</a>\n                    <a href="javascript:void(0);" class="')
                                        .concat(c.UI, " ")
                        ...
                        case P.SUB_CONTAINER_BOTTOM:
                            return '\n                <div class="'
                                ...
                                .concat(t === P.SUB_CONTAINER_BOTTOM ? c.TOOLBAR_SUB_CONTAINER_BOTTOM : "", '">\n                    <a href="javascript:void(0)" class="')
                                .concat(c.UI, " ")
                                .concat(c.ADD_CONTENT, '" title="')
                        ...
                        case P.COMPONENT_BOTTOM:
                            return '\n                <div class="'
                                ...
                                .concat(c.TOOLBAR, " ")
                                .concat(c.TOOLBAR_BOTTOM, " ")
                                .concat(c.TOOLBAR_COMPONENT_BOTTOM, '">\n                    <a href="javascript:void(0)" class="')
                                .concat(c.UI, " ")
                                .concat(c.ADD_CONTENT, '" title="')
                                .concat(e.locale.addContentBelow, '">')
                                .concat(D.ADD_CONTENT, '</a>\n                    <a href="javascript:void(0)" class="')
                ...
                B = function (t) {
                    ...
                    return (
                        ...
                        ("string" == typeof n.defaultComponentType ? (e = n.defaultComponentType) : "function" == typeof n.defaultComponentType && (e = n.defaultComponentType.call(this, t)),
                ...
                b = function (t) {
                    ...
                    if (!t.hasClass(c.STATE_INITIALIZED) || !t.hasClass(c.STATE_INITIALIZING)) {
                        ...
                        "function" == typeof e.onInitComponent && e.onInitComponent.call(n, t, a),
                ...
                L = function (t, n) {
                    if (!t.is(".".concat(c.TOOLBAR_CONTAINER_CONTENT))) {
                        ...
                        t.wrap('<section class="'.concat(c.UI, " ").concat(c.COMPONENT, '" data-type="').concat(t.attr("data-type"), '" ').concat(o.join(" "), "></section>")),
                            t.wrap('<section class="'.concat(c.UI, " ").concat(c.COMPONENT_CONTENT, '"></section>')),
                            (e = t.parent().parent()),
                        ...
                        l.sortable({
                            ...
                            receive: function (n, e) {
                                var o,
                                    ...
                                    s = e.item;
                                l && l.remove(),
                                (o = s.closest(".".concat(c.CONTAINER))).hasClass(c.STATE_TOOLBAR_SHOWED) ||
                                (r.find(".".concat(c.CONTAINER, ".").concat(c.STATE_TOOLBAR_SHOWED)).removeClass(c.STATE_TOOLBAR_SHOWED), o.addClass(c.STATE_TOOLBAR_SHOWED)),
                                "function" == typeof i.onContainerChanged && i.onContainerChanged.call(a, n, o, t),
                                "function" == typeof i.onContentChanged && i.onContentChanged.call(a, n, t),
                ...
                W = function (t) {
                    ...
                    "function" == typeof e.onBeforeInitContainer && e.onBeforeInitContainer.call(n, t, a),
                    o && t.addClass(c.SUB_CONTAINER),
                        t.append(g.call(n, o ? P.SUB_CONTAINER : P.CONTAINER, e.containerSettingEnabled) + g.call(n, o ? P.SUB_CONTAINER_BOTTOM : P.CONTAINER_BOTTOM)),
                        t.attr("id", s()),
                    ...
                    "function" == typeof e.onInitContainer && e.onInitContainer.call(n, t, a),
                        t.addClass(c.STATE_INITIALIZED),
                        t.removeClass(c.STATE_INITIALIZING));
                },
                V = function (t) {
                ...
                G = function (t, n, e, o) {
                    var a,
                        ...
                        u = !1;
                    if (
                        ("container" === E ? (f = !0) : (N && !p && (C = !0), N && p && (e.is(".".concat(c.CONTAINER_CONTENT_INNER)) ? (C = !0) : o === y.APPEND ? (u = !0) : (C = !0))),
                            this.contentAreasWrapper.find(".".concat(c.STATE_TOOLBAR_SHOWED)).removeClass(c.STATE_TOOLBAR_SHOWED),
                        f &&
                        ((a = $(O)),
                            e[o](a),
                        "function" == typeof l.onContainerSnippetAdded && l.onContainerSnippetAdded.call(this, t, a, n, s),
                        "function" == typeof l.onContentChanged && l.onContentChanged.call(this, t, s),
                            V.call(this, a),
                            a.trigger("click")),
                        C || u)
                    ) {
                    ...
                    "function" == typeof l.onComponentSnippetAdded && l.onComponentSnippetAdded.call(this, t, i, n, s),
                    "function" == typeof l.onContentChanged && l.onContentChanged.call(this, t, s),
                        L.call(this, i),
                        i.trigger("click"));
                    u &&
                    ((a = $(l.containerForQuickAddComponent)).find('[data-type="container-content"]').eq(0).html(i),
                        e[o](a),
                    "function" == typeof l.onComponentSnippetAdded && l.onComponentSnippetAdded.call(this, t, i, n, s),
                    "function" == typeof l.onContentChanged && l.onContentChanged.call(this, t, s),
                        V.call(this, a),
                    ...
                    var n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                        ...
                        i = $(
                            '\n        <div class="'
                                ...
                                .concat(t, '">\n            <div class="')
                                .concat(c.MODAL_HEADER, '">\n                <button type="button" class="')
                                .concat(c.MODAL_CLOSE, '">&times;</button>\n                <h4 class="')
                                .concat(c.MODAL_TITLE, '"></h4>\n            </div>\n            <div class="')
            ...
            var Q = function () {
                ...
                X = function () {
                    var t = this,
                        ...
                        e = (t.sidebar = $(
                            '\n        <div class="'
                                ...
                                .concat(c.UI, " ")
                                .concat(c.SIDEBAR_TITLE, '"></span>\n                <a href="javascript:void(0);" class="')
                                .concat(c.UI, " ")
                                .concat(c.SIDEBAR_CLOSER, '">&times;</a>\n            </div>\n            <div class="')
                                .concat(c.UI, " ")
                    ...
                    e.find(".".concat(c.SIDEBAR_CLOSER)).on("click", function (n) {
                        ...
                        (t.sidebarBody = e.find(".".concat(c.SIDEBAR_BODY))).on("submit", "form", function (t) {
                            return t.preventDefault(), !1;
                        }),
                        e.appendTo(t.wrapper);
                },
                J = { MOBILE: "MOBILE", TABLET: "TABLET", LAPTOP: "LAPTOP", DESKTOP: "DESKTOP" },
                tt = function (t, n) {
                    var e = this.options,
                        o = this.topbarCenter,
            ...
            var at = function (t) {
                    var n = this,
                        e = [];
                    return (
                        n.contentAreasWrapper.find(".".concat(c.CONTENT_AREA_INNER)).each(function () {
                            var t = "";
                            $(this)
                ...
                ct = function () {
                    ...
                    (t.previewArea = $('<div class="'.concat(c.PREVIEW_AREA, '"></div>'))),
                        ...
                        e.on("click", function (o) {
                            ...
                            e.html(a ? D.PREVIEW_ON : D.PREVIEW_OFF),
                                ...
                                t.iframeBody[a ? "addClass" : "removeClass"](c.STATE_PREVIEWING),
                                t.previewArea.html(""),
                                Y.call(t),
                            a &&
                            t.previewArea
                ...
                Et = function () {
                    ...
                    (this.topbar = $(
                        '\n        <div class="'
                            ...
                            .concat(n.title, '</div>\n            </div>\n            <div class="')
                            .concat(c.UI, " ")
                            .concat(c.TOPBAR_CENTER, '">\n            </div>\n            <div class="')
                            .concat(c.UI, " ")
                            .concat(c.TOPBAR_RIGHT, '">\n            </div>\n        </div>\n    ')
                    )),
                ...
                pt = function (t, n) {
                    (this.copyContent = n ? null : t),
                        ...
                        this.contentAreasWrapper.find(".".concat(c.UI_CUTTING)).removeClass(c.UI_CUTTING),
                        this.iframeBody.removeClass("".concat(c.STATE_COPYING, " ").concat(c.STATE_COPYING_COMPONENT, " ").concat(c.STATE_COPYING_CONTAINER, " ").concat(c.STATE_COPYING_SUB_CONTAINER)),
                    t &&
                    (n && t.addClass(c.UI_CUTTING),
                        this.iframeBody.addClass(c.STATE_COPYING),
                    t.hasClass(c.COMPONENT) && this.iframeBody.addClass(c.STATE_COPYING_COMPONENT),
                    t.hasClass(c.CONTAINER) && this.iframeBody.addClass(t.hasClass(c.SUB_CONTAINER) ? c.STATE_COPYING_SUB_CONTAINER : c.STATE_COPYING_CONTAINER));
                },
                ft = function () {
                    var t = this;
                ...
                Ct = function () {
                    ...
                    t.contentAreasWrapper.on("click", ".".concat(c.PASTE_CONTENT), function (n) {
                        ...
                        d.length > 0 &&
                        (d.hasClass(c.TOOLBAR_CONTAINER_BOTTOM) && (r("Target is container"), (E = o.closest(".".concat(c.CONTAINER)))),
                        d.hasClass(c.TOOLBAR_COMPONENT_BOTTOM) && (r("Target is component"), (E = o.closest(".".concat(c.COMPONENT)))));
                        ...
                        (p = d.length > 0 ? y.AFTER : y.APPEND),
                            r("isCopy: ".concat(a, " | isComponent: ").concat(l, " | isContainer: ").concat(s, " | isSubContainer: ").concat(T, " | action: ").concat(p)),
                            r("target: ", E),
                            E[p](e),
                            pt.call(t, null),
                ...
                _t = function () {
                    ...
                    t.contentAreasWrapper.on("click", ".".concat(c.COMPONENT_DELETE), function (e) {
                        ...
                        if (confirm(n.locale.confirmDeleteComponentText)) {
                            ...
                            "function" == typeof n.onBeforeComponentDeleted && n.onBeforeComponentDeleted.call(t, e, a, r),
                            a.is(t.settingComponent) && Y.call(t),
                                ht.call(t, a),
                            "function" == typeof n.onComponentDeleted && n.onComponentDeleted.call(t, e, a, r),
                            "function" == typeof n.onContainerChanged && n.onContainerChanged.call(t, e, i, r),
                            "function" == typeof n.onContentChanged && n.onContentChanged.call(t, e, r);
                        }
                    });
                },
                It = function () {
                    ...
                    t.contentAreasWrapper.on("click", ".".concat(c.COMPONENT_DUPLICATE), function (e) {
                        ...
                        o.after(r),
                            L.call(t, r),
                        "function" == typeof n.onComponentDuplicated && n.onComponentDuplicated.call(t, o, r, i),
                        "function" == typeof n.onContainerChanged && n.onContainerChanged.call(t, e, a, i),
                        "function" == typeof n.onContentChanged && n.onContentChanged.call(t, e, i);
                    });
                },
                vt = function () {
                    var t = this;
                    ...
                    t.contentAreasWrapper.on("click", ".".concat(c.CONTAINER_DELETE), function (e) {
                        ...
                        if (confirm(n.locale.confirmDeleteContainerText)) {
                            ...
                            i.each(function () {
                                ...
                                a.remove(),
                            "function" == typeof n.onContainerDeleted && n.onContainerDeleted.call(t, e, a, r),
                            "function" == typeof n.onContentChanged && n.onContentChanged.call(t, e, r);
                        }
                    });
                },
                ...
                Ft = function () {
                    var t = this.element,
                        ...
                        o = (this.wrapper = $(
                            '\n        <div id="'
                                ...
                                .concat(c.UI, " ")
                                .concat(c.IFRAME_WIDTH_SWITCHER, '">\n                    <iframe class="')
                                .concat(c.UI, " ")
                                .concat(c.IFRAME, '"></iframe>\n                </div>\n            </div>\n        </div>\n    ')
                        ));
                    ...
                    (this.iframeDoc = a.contents()),
                        ...
                        (this.iframeWindow = a[0].contentWindow ? a[0].contentWindow : a[0].contentDocument.defaultView),
                    ...
                    $.each(n.contentStyles, function (t, n) {
                        ...
                        this.contentAreasWrapper.attr("class", "".concat(c.UI, " ").concat(c.CONTENT_AREAS_WRAPPER)),
                        this.contentAreasWrapper.html(t.val() || t.html() || ""),
                    this.contentAreasWrapper.attr("id") || this.contentAreasWrapper.attr("id", this.generateId()),
                        this.iframeBody.append(this.contentAreasWrapper).addClass(c.IFRAME_BODY),
                    "function" == typeof n.onInitIframe && n.onInitIframe.call(this, this.iframe, this.iframeHead, this.iframeBody),
                        wt.call(this),
                        kt.call(this);
                },
                Wt = function (t, n) {
                    ...
                    "function" == typeof this.options.onReady && this.options.onReady.call(this);
                },
                $t = function () {
                    var t = this.element,
                        n = this.id,
                        ...
                        (o = [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                    t.each(function () {
                                        M.call({ options: { onDynamicContentLoaded: n.onSuccess, onDynamicContentError: n.onError } }, a()(this));
                                    });
                                },
                            },
                        ]),
